...
- Start by getting a hold of API keys for the nessus scanners you want to interact with. New API keys can be generated from nessus web GUI under My Account -> API Keys 
